...
Control the language that your AI Agents write replies in. Select "Use same language of incoming ticket" to make sure the AI Agent replies in the language of the customer. To implement custom language logic, such as having the AI Agent answer in Dutch (if customer speaks Dutch) or English only, select "Other" and describe your logic it in natural language. Additionally, the AI Agent can also generate translations of incoming messages (and suggestions if not in automation mode) . Once toggled on, select the preferred language to translate messages in. If the message is sent in your preferred language, no translation will be made.
...
Never describe multi-step procedures, details about integrations and other business processes in tone of voice, rather use [protocols](/training/protocols) for adding processes and integration specific instructions.
...
- **Can I teach the Agent what greeting / signoff to use in Tone of Voice?**\
...
- [_"If the customer explicitly mentiones they are happy, ask them for a review and send them the following invitation link: https://www.trustpilot.com/review/sitright.nl"_](https://www.trustpilot.com/review/sitright.nl)
...
Allows you to set topics that the Agent should never reply to. If a message is sent that triggers the no reply topics, the Agent will do nothing and leave the ticket open for the user. You can see this as a spam-filter, but for the AI Agent. Be as specific as possible for the most reliable results.