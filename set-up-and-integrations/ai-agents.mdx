...
Never describe multi-step procedures, details about integrations and other business processes in tone of voice, rather use [protcols](/training/protocols) for adding processes and integration specific instructions.
...
Allows you to set topics that the Agent should never reply to. If a message is sent that triggers the no reply settings, the Agent will do nothing and leave the ticket open for the user. You can see this as a spam-filter, but for the AI Agent. Be as specific as possible for the most reliable results.