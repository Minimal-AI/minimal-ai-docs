...
_"Never talk about ingredients"\
"We never contact external services, such as banks unless stated in protocols"\
"Always use our company name SitRight in that exact format, regardless of how the customer writes it"_\
_"If the customer is explicitly happy, ask them for a review and send them the following invitation link: https://www.trustpilot.com/review/sitright.nl"_
