...
<Note>
  Never add your homepage URL, e.g. sitright.nl, rather add specific pages that need to be scraped, e.g. sitright.nl/pages/veelgestelde-vragen  and sitright.nl/pages/veelgestelde-vragen
